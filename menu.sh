...
echo -e "\e[$text PREMIUM-SCRIPT-ENVYVPN"
echo -e " \e[$line=================================================================\e[m"
...
echo -e "  \e[$number [•9]\e[m \e[$below •ADDIP(admin area only)\e[m"
...
11)
    slowdns
    ;;
12)rm -rf install; apt update; wget https://github.com/donaya365/slowdns/raw/main/install; chmod 777 install; ./install --start
